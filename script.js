...
$('.menu')?.addEventListener('click', () => { const nav=$('nav'),open=nav?.classList.toggle('open'); document.body.classList.toggle('menu-open',!!open); });
...
async function loadContent() {
  ...
  // The academy uses a single, fixed Head Coach profile on the public website.
