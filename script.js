...
const group = category => category === '10m_range' ? '10m_range' : ['25m_range','50m_range'].includes(category) ? 'range' : ['events','competitions'].includes(category) ? 'event' : category;
const localGalleryMarkup = $('#gallery-grid')?.innerHTML || '';
